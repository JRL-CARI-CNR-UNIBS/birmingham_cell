...
if complete:
    model = TD3.load(pack_path + '/model/peg_in_hole_model.zip')
    ...
    grasp_model = TD3.load(pack_path + '/model/f_g_model.zip')
    insert_model = TD3.load(pack_path + '/model/f_i_model.zip')
